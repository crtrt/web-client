<template>
    <div class="body">
            <el-table
                ...
                <el-table-column
                        prop="firstguardian_name"
                        label="第一监护人"
                        width="180">
                </el-table-column>
                <el-table-column
                        prop="secondguardian_name"
                        label="第二监护人">
                </el-table-column>

                <el-table-column width="100"    label="操作">
                    <template slot-scope="scope" >
                        <el-button  size="mini"  type="primary" @click="updateOld(scope.row.id)">修改</el-button>
                    </template>
                </el-table-column>

                <el-table-column width="100" label="操作">
                    <template slot-scope="scope" >
                        <el-button  size="mini"  type="warning" @click="deleteOld(scope.row.id)">删除</el-button>
                    </template>
                </el-table-column>
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="addPerson(infoForm)">注 册</el-button>
             </span>
        </el-dialog>
    </div>
</template>
...
<script>
    import {getOldList, addOld,deleteOldInfo} from "@/api";
    ...
    export default {
        ...
        methods: {
            ...
            deleteOld(id){
                let _this = this
                let params = new URLSearchParams()
                params.append('old_id', id)
                deleteOldInfo(params)
                    .then(res => {
                        console.log(res)
                        if (res.code === 1) {
